...
if (!$U["islogin"]) {
	...
	if ($_POST["action"] === "new") {
		if (isset($D["admin"][$_POST["account"]])) {
			?>
			<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			$sth->execute();
			$D["admin"][$_POST["account"]] = array("account"=>$_POST["account"], "name"=>$_POST["name"]);
			?>
		...
		if ($_POST["name"] !== "") {
			...
			$sth->bindValue(":account", $_POST["account"]);
			$sth->execute();
			$D["admin"][$_POST["account"]]["name"] = $_POST["name"];
			?>
			<div class="alert alert-success alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	...
	if (!isset($D["admin"][$_POST["delete"]])) {
		...
		<?php
	} else if ($_POST["delete"] == $U["account"]) {
		?>
		<div class="alert alert-danger alert-dismissible" role="alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			您不能刪除自己
